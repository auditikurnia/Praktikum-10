...
$tai = mysqli_query($conn, "SELECT * FROM tb_covid19 WHERE negara='Taiwan'");
...
var data = {
            labels: ["Total Cases","Total Deaths","Total Recovered","Active Cases","Total Test"],
            datasets: [
                {
                    label: "India",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($india)) { echo '"' . $p['totalcases'] . '","' . $p['totaldeaths'] . '","' . $p['totalrecovered'] . '","' . $p['activecases'] . '","' . $p['totaltest'] . '",';}?>]
                },
                {
                    label: "Korea Selatan",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($korsel)) { echo '"' . $p['totalcases'] . '","' . $p['totaldeaths'] . '","' . $p['totalrecovered'] . '","' . $p['activecases'] . '","' . $p['totaltest'] . '",';}?>]
                },
                {
                    label: "Turkey",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($turkey)) { echo '"' . $p['totalcases'] . '","' . $p['totaldeaths'] . '","' . $p['totalrecovered'] . '","' . $p['activecases'] . '","' . $p['totaltest'] . '",';}?>]
                },
                {
                    label: "Vietnam",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($vietnam)) { echo '"' . $p['totalcases'] . '","' . $p['totaldeaths'] . '","' . $p['totalrecovered'] . '","' . $p['activecases'] . '","' . $p['totaltest'] . '",';}?>]
                },
                {
                    label: "Japan",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($japan)) { echo '"' . $p['totalcases'] . '","' . $p['totaldeaths'] . '","' . $p['totalrecovered'] . '","' . $p['activecases'] . '","' . $p['totaltest'] . '",';}?>]
                },
                {
                    label: "Iran",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($iran)) { echo '"' . $p['totalcases'] . '","' . $p['totaldeaths'] . '","' . $p['totalrecovered'] . '","' . $p['activecases'] . '","' . $p['totaltest'] . '",';}?>]
                },
                {
                    label: "Indonesia",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($indo)) { echo '"' . $p['totalcases'] . '","' . $p['totaldeaths'] . '","' . $p['totalrecovered'] . '","' . $p['activecases'] . '","' . $p['totaltest'] . '",';}?>]
                },
                {
                    label: "Malaysia",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($malay)) { echo '"' . $p['totalcases'] . '","' . $p['totaldeaths'] . '","' . $p['totalrecovered'] . '","' . $p['activecases'] . '","' . $p['totaltest'] . '",';}?>]
                },
                {
                    label: "Taiwan",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($tai)) { echo '"' . $p['totalcases'] . '","' . $p['totaldeaths'] . '","' . $p['totalrecovered'] . '","' . $p['activecases'] . '","' . $p['totaltest'] . '",';}?>]
                },
                {
                    label: "Israel",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($israel)) { echo '"' . $p['totalcases'] . '","' . $p['totaldeaths'] . '","' . $p['totalrecovered'] . '","' . $p['activecases'] . '","' . $p['totaltest'] . '",';}?>]
                }
                ]
        };
