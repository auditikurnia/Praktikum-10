...
{
	$query = mysqli_query($conn,"SELECT sum(totalcases) AS jumlah FROM tb_covid19 WHERE id_covid='$bulan'");
...
for($bulan = 1;$bulan < 11;$bulan++)
{
	$query = mysqli_query($conn,"SELECT sum(totaldeaths) AS jumlah FROM tb_covid19 WHERE id_covid='$bulan'");
	$row = $query->fetch_array();
...
for($bulan = 1;$bulan < 11;$bulan++)
{
	$query = mysqli_query($conn,"SELECT sum(totalrecovered) AS jumlah FROM tb_covid19 WHERE id_covid='$bulan'");
	$row = $query->fetch_array();
...
for($bulan = 1;$bulan < 11;$bulan++)
{
	$query = mysqli_query($conn,"SELECT sum(activecases) AS jumlah FROM tb_covid19 WHERE id_covid='$bulan'");
	$row = $query->fetch_array();
...
for($bulan = 1;$bulan < 11;$bulan++)
{
	$query = mysqli_query($conn,"SELECT sum(totaltest) AS jumlah FROM tb_covid19 WHERE id_covid='$bulan'");
	$row = $query->fetch_array();
